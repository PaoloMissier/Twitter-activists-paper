...
%
The DB enables user-defined scoring functions to be tested, providing a user ranking list (6). Examples of these are given later in Sec.~\ref{sec:evaluationlk} \anote{check all references as there are several errors, from undefined to multiply-defined references}.
