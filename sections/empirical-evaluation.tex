...
\begin{table}
	...
	\caption{Top-10 users for ranking functions (\ref{eq:rank1}) and (\ref{eq:rank2}), with indication of whether the user is on/off-topic and individual vs associations / professionals.}
	\label{tab:rank1}
	\vspace{-30pt}
\end{table}
%
