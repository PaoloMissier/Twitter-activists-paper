...
Our results show that (\ref{eq:rank1}) seems to favour more on-topic users (90\% for (\ref{eq:rank1}) vs 70\% for (\ref{eq:rank2} vs \_\% for (\ref{eq:rank3})), 
while (\ref{eq:rank3}) favours more individuals (55\% for (\ref{eq:rank1}) vs 71\% for (\ref{eq:rank2} vs \_\% for (\ref{eq:rank3})), among in-topic users.
%
