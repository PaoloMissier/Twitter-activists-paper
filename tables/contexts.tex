...
\begin{tabularx}{\textwidth}{|X|p{1.8cm}|p{1.2cm}|p{1.1cm}|p{1.4cm}|p{1.2cm}|p{1.3cm}|p{1.1cm}|}

\hline
\textbf{Context name} & \textbf{Period} & \textbf{Nodes} & \textbf{Edges} & \textbf{Density} & \textbf{Avg \newline degree} & \textbf{Assor-tativity} & \textbf{Scc / nodes} \\ \hline
